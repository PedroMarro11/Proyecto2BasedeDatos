...
(12, 'Natasha', 'Romanoff', true, '2022-10-15'),
(13, 'Kara', 'Kent', true, '2022-10-15'),
(14, 'James', 'Howlett', true, '2022-10-15'),
(15, 'Steve', 'Rogers', true, '2022-10-15')

SELECT * FROM instructor ORDER BY idinstructor